...
<h:body>
    ...
    <div class="wrapper container">
        ...
        <div class="row">
            ...
            </p>В сертификационных тестах задания трёх категорий: А B и C. Каждый участник должен пройти определённый набор тестов для получения сертификата.
            </article>
            <article class="col-md-3">
                <p>
                    Результаты?
    ...
    <footer>
        <div class="container">
            <div class=" text-left">
Made by: <br>Sid775@mail.ru<br>Lypinam@rambler.ru<br>Sivkostja@gmail.com
            </div>
        </div>
    </footer>
</h:body>
